          ...
          <div className="flex items-center gap-3 flex-1 justify-end">
            ...
            <div className="flex md:hidden relative flex-1 max-w-xs">
              <input
                ...
                className="w-full px-3 py-2 text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-sky-300 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-200"
                placeholder="Search..."
              />
              {results.length > 0 && (
