      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/yourusername" target="_blank" rel="noreferrer" className="text-gray-600 dark:text-slate-200 hover:text-sky-600 dark:hover:text-sky-300">
              {/* GitHub svg */}
            ...
            <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noreferrer" className="text-gray-600 dark:text-slate-200 hover:text-sky-600 dark:hover:text-sky-300">
            ...
            <a href="https://twitter.com/yourusername" target="_blank" rel="noreferrer" className="text-gray-600 dark:text-slate-200 hover:text-sky-600 dark:hover:text-sky-300">
